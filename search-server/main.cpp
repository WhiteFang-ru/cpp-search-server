...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query) const {
        vector<Document> top_docs =  FindTopDocuments(raw_query, [](int document_id, DocumentStatus status, int rating) {
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status) const {
        vector<Document> top_docs =  FindTopDocuments(raw_query, [status](int document_id, DocumentStatus stat, int rating) {
            return stat == status;
        });
        return top_docs;
    }
